/proc/possess(obj/O in world)
	...
	O.AddElement(/datum/element/weather_listener, /datum/weather/rain, ZTRAIT_RAIN, GLOB.rain_sounds) //STAR EDIT ADDITION
...
/proc/release()
	...
	usr.control_object.RemoveElement(/datum/element/weather_listener, /datum/weather/rain, ZTRAIT_RAIN, GLOB.rain_sounds) //STAR EDIT ADDITION
