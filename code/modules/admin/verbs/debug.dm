...
//STAR EDIT START//
	for(var/name in SSmapping.lushplanet_ruins_templates)
		names[name] = list(SSmapping.lushplanet_ruins_templates[name], ZTRAIT_LUSHPLANET_RUINS, list(/area/lush_planet/unexplored))
//STAR EDIT END//
