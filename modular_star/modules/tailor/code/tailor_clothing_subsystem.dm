...
/datum/tailor_clothing/proc/get_json()
	return json_encode(list("name" = name, "desc" = desc, "ckey_author" = ckey_author, "author" = author, "id" = id, "slot" = slot, "banned" = banned))

/datum/tailor_clothing/proc/get_list()
	return list("name" = name, "desc" = desc, "ckey_author" = ckey_author, "author" = author, "id" = id, "slot" = slot, "banned" = banned)
